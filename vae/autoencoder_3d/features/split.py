...
#            inputs, labels = batch
#            
#            # Function to recursively get the shape of a list
...
#            list_shape1 = get_list_shape(inputs)
#            list_shape2 = get_list_shape(labels)
#
#            #print(list_shape)
#
#            # 打印数据形状
#            print("Inputs shape:", inputs[0][1][0])
#            print("Inputs shape:", inputs[0][1].shape)
#            print("Inputs shape:", inputs[0][0].shape)
#            print("Labels shape:", labels.shape)
##            np.save('input.npy', np.array(inputs[0][0]))
