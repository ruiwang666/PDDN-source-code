...
#            proj = nn.Conv3d(ae.latent_channels, embed_dim[i], kernel_size=1)
...
#        def process_input(i):
#        print(x[0].shape)
        z = self.autoencoder[0].encode(x) # 8, 32, 1, 64, 64]
#        print('!!!!!!!!z = self.autoencoder[i].encode(x[i])[0]!!!!!!!!!!!!')
#        print(z.shape)
#        z = self.proj[0](z) # [8, 128, 1, 64, 64]
#            print('!!!!!!!!z = self.proj[i](z)!!!!!!!!!!!!')
#            print(z.shape)
#            z = z.permute(0,2,3,4,1) # [8, 1, 64, 64, 128]
#            print('!!!!!!!!z = z.permute(0,2,3,4,1)!!!!!!!!!!!!')
#            print(z.shape)
#            z = self.analysis[i](z) # 8, 1, 64, 64, 128]
#            print('!!!!!!!!z = self.analysis[i](z)!!!!!!!!!!!!')
#            print(z.shape)
#            if self.use_temporal_transformer:
...
#        print('!!!!!!!!x = [process_input(i) for i in range(len(x))]!!!!!!!!!!!!')
#        print(x.shape)
        
        # merge inputs
#        x = self.fusion(x) # [8, 5, 64, 64, 128]
#        print('!!!!!!!!x = self.fusion(x)!!!!!!!!!!!!')
#        print(x.shape)
        # produce prediction
#        x = self.forecast(x)
#        print('!!!!!!!!!!!!!!!!!!!!x = self.forecast(x)!!!!!!!!!!!!!!!!!')
#        print(z.shape)   # [8, 128, 5, 64, 64]
        return z # to channels-first order
...
class AFNONowcastNet(AFNONowcastNetBase):
    def __init__(self, autoencoder, output_autoencoder=None, **kwargs):
        ...
        self.out_proj = nn.Conv3d(
            self.embed_dim_out, output_autoencoder.latent_channels, kernel_size=1
        )
